...
function renderText() {
  ...
  document.getElementById('kpi-row').innerHTML = [
    ...
    kpi({ label: t('kpi_tw_poultry'), value: surv.taiwan_poultry.cumulative_outbreaks, sub: t('kpi_tw_poultry_sub', { since: surv.taiwan_poultry.since, win: pick(surv.taiwan_poultry, 'season_window') }), accent: 'danger' })
  ].join('');
